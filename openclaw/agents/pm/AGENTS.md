...
- Secondary: `developer` (for implementation task breakdown)
- Coordination: `scrum-master` (for sprint planning)

## Receiving From
- `analyst` (project briefs)
- Any agent (product decision requests and scope questions)

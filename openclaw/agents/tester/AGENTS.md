...
|-------|-----|------|-----------------|
| Business Analyst | analyst | Requirements, research | For acceptance criteria clarifications |
...
- Secondary: `scrum-master` (quality sign-off after all tests pass)

## Receiving From
- `developer` (implementations ready for testing)
- `pm` (PRDs for early test plan creation)
- `architect` (architecture specs for non-functional test planning)

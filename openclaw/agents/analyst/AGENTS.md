...
|-------|-----|------|-----------------|
| Product Manager | pm | PRD creation, roadmap | After completing project brief |
...
- Secondary: `architect` (for technical feasibility)

## Receiving From
- User (new project requests and requirements)
- Any agent (requirement clarification requests)
